...
#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "1698949521"))
...
TUT_VID = os.environ.get("TUT_VID","https://t.me/how_to_download_tut/2")
...
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>» ʙʏ @Kdrama_Time</b>")
